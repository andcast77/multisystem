...
export function registerRoutes(fastify: FastifyInstance) {
  fastify.get('/v1/shopflow/products', {
    preHandler: pre,
    schema: { response: { 200: apiOkEnvelope200 } },
  }, handle(listProducts))
  fastify.get('/v1/shopflow/products/low-stock', { preHandler: pre }, handle(getProductsLowStock))
  fastify.get('/v1/shopflow/products/units', { preHandler: pre }, handle(listProductUnits))
  fastify.get<{ Params: { id: string } }>('/v1/shopflow/products/:id', { preHandler: pre }, handle(getProductById))
  fastify.post('/v1/shopflow/products', { preHandler: pre }, handle(createProduct))
  fastify.put<{ Params: { id: string } }>('/v1/shopflow/products/:id', { preHandler: pre }, handle(updateProduct))
  fastify.put<{ Params: { id: string } }>('/v1/shopflow/products/:id/inventory', { preHandler: pre }, handle(updateProductInventory))
  fastify.delete<{ Params: { id: string } }>('/v1/shopflow/products/:id', { preHandler: pre }, handle(deleteProduct))
}
