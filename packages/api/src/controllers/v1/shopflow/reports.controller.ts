...
export function registerRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/v1/shopflow/reports/top-products', { preHandler: pre }, handle(getTopProducts))
  fastify.get('/v1/shopflow/reports/payment-methods', { preHandler: pre }, handle(getPaymentMethods))
  fastify.get('/v1/shopflow/reports/inventory', { preHandler: pre }, handle(getInventoryReport))
