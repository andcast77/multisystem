...
export function registerRoutes(fastify: FastifyInstance) {
  fastify.get('/v1/shopflow/customers', { preHandler: pre }, handle(listCustomers))
  fastify.get<{ Params: { id: string } }>('/v1/shopflow/customers/:id', { preHandler: pre }, handle(getCustomerById))
  fastify.post('/v1/shopflow/customers', { preHandler: pre }, handle(createCustomer))
  fastify.put<{ Params: { id: string } }>('/v1/shopflow/customers/:id', { preHandler: pre }, handle(updateCustomer))
  fastify.delete<{ Params: { id: string } }>('/v1/shopflow/customers/:id', { preHandler: pre }, handle(deleteCustomer))
}
