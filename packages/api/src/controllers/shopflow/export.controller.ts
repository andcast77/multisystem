...
export function registerRoutes(fastify: FastifyInstance) {
  ...
  fastify.post('/api/shopflow/export/jobs', { preHandler: pre }, handle(createJob))
  fastify.get<{ Params: { jobId: string } }>('/api/shopflow/export/jobs/:jobId', { preHandler: pre }, handle(getJob))
  fastify.get<{ Params: { jobId: string } }>('/api/shopflow/export/jobs/:jobId/download', { preHandler: pre }, handle(downloadJob))
}
