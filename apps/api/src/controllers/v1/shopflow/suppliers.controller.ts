...
export function registerRoutes(fastify: FastifyInstance) {
  fastify.get('/v1/shopflow/suppliers', { preHandler: pre }, handle(listSuppliers))
  fastify.get<{ Params: { id: string } }>('/v1/shopflow/suppliers/:id', { preHandler: pre }, handle(getSupplierById))
  fastify.post('/v1/shopflow/suppliers', { preHandler: pre }, handle(createSupplier))
  fastify.put<{ Params: { id: string } }>('/v1/shopflow/suppliers/:id', { preHandler: pre }, handle(updateSupplier))
  fastify.delete<{ Params: { id: string } }>('/v1/shopflow/suppliers/:id', { preHandler: pre }, handle(deleteSupplier))
}
