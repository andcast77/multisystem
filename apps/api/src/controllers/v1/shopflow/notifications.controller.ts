...
export function registerRoutes(fastify: FastifyInstance) {
  ...
  fastify.put<{ Params: { id: string } }>('/v1/shopflow/notifications/:id/read', { preHandler: pre }, handle(markNotificationAsRead))
  fastify.put<{ Params: { id: string } }>('/v1/shopflow/notifications/:id/unread', { preHandler: pre }, handle(markNotificationAsUnread))
  fastify.put('/v1/shopflow/notifications/read-all', { preHandler: pre }, handle(markAllNotificationsRead))
  fastify.delete<{ Params: { id: string } }>('/v1/shopflow/notifications/:id', { preHandler: pre }, handle(deleteNotification))
